...
import { toDecimal, videoHandler } from '~/utils';
...
*/
    const addToCartHandler = () => {
        ...
        if (product.stock > 0 && cartActive) {
            addToCart({ ...product.data, product, qty: quantity, price: product.prodPrice });
            /*
            if (product.data.variants.length > 0) {
    ...
    return (
        <div className={"product-details " + adClass}>
            ...
            <div className='product-meta'>
                SKU: <span className='product-sku'> 125445684 </span>
                CATEGORIES: <span className='product-brand'> {product.category}
                    {/*
            ...
            <div className="product-price mb-2">
                {<ins className="new-price">${toDecimal(product.prodPrice)}</ins>
                    /*
                ...
                isStickyCart ?
                    ...
                    <div className="product-form product-qty pb-0">
                        ...
                        <div className="product-form-group">
                            ...
                            <button className={`btn-product btn-cart text-normal ls-normal font-weight-semi-bold ${cartActive ? '' : 'enabled'}`} onClick={addToCartHandler}><i className='d-icon-bag'></i>Add to Cart</button>
                        </div>
                    </div>
            }
