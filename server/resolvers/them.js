const { getMinMaxPrice, getDiscount, isSaleProduct } = require('../src/helpers/index');
...
module.exports = {
    ...
    Query: {
        hello1: async (root, args, ctx, info) => {
            console.log("hay")
            return 'team';
        ...
        products: async (root, args, ctx, info) => {
            const demoData = require(`../src/data/demo-${args.demo}.json`);
